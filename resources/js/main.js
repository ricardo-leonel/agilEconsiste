...
Modernizr.load({
  ...
  nope: '../resources/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['../resources/plugins/fix/ios-fix/ios-orientationchange-fix.js', '../resources/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
